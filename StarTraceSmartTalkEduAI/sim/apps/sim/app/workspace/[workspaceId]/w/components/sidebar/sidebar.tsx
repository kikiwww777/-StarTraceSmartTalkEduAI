...
import { ArrowDown, BarChart3, BookOpen, Database, GraduationCap, HelpCircle, Layout, Plus, Search, Settings, Users } from 'lucide-react'
...
export function Sidebar() {
  ...
  const footerNavigationItems = useMemo(
    () => [
      ...
      {
        id: 'education-templates',
        label: '教育模板库',
        icon: GraduationCap,
        href: `/workspace/${workspaceId}/templates/education`,
      },
      {
        id: 'knowledge-base',
          ...
          >
            <div className='flex h-full flex-col border-[var(--border)] border-r pt-[12px]'>
              ...
              <div className='flex-shrink-0'>
                <CourseSelector currentWorkspaceId={workspaceId} />
              </div>
