# ========================================
# Base Stage: Alpine-based Bun
# ========================================
FROM oven/bun:1.3.3-alpine AS base

# Install common build dependencies + Node.js toolchain for node-gyp
RUN apk add --no-cache \
    python3 make g++ curl ca-certificates bash ffmpeg nodejs npm

# In some restricted networks, TLS inspection can break package downloads.
# These env vars relax TLS verification during image build.
...
# Create non-root user and group (Alpine)
